...
gs-balanceui-shop-buy-token-admin-abuse = Токен на админарбуз - { $price }§
...
gs-balanceui-remark-token-antag = Куплен токен антага - НЕ ИСПОЛЬЗОВАНО
gs-balanceui-remark-token-admin-abuse = Куплен токен злоупотребления админом - НЕ ИСПОЛЬЗОВАНО
gs-balanceui-remark-token-hat = Куплен токен шляпы - НЕ ИСПОЛЬЗОВАНО
